...
public class MotherboardDto {
    ...
    public MotherboardDto(String name, String producer, Integer ramSlotCapacity, Integer maxInternalMemory, Integer numOfMemorySlots, String ramSlotType, String socket, String gpuSlot) {
        this.name = name;
        this.producer = producer;
        this.ramSlotCapacity = ramSlotCapacity;
        this.maxInternalMemory = maxInternalMemory;
